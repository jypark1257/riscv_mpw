...
## PMOD Header JA
set_property -dict { PACKAGE_PIN U27   IOSTANDARD LVCMOS33 } [get_ports { i_sclk }]; #IO_L13P_T2_MRCC_14 Sch=ja_p[1]
set_property -dict { PACKAGE_PIN U28   IOSTANDARD LVCMOS33 } [get_ports { i_cs }]; #IO_L13N_T2_MRCC_14 Sch=ja_n[1]
set_property -dict { PACKAGE_PIN T26   IOSTANDARD LVCMOS33 } [get_ports { i_mosi }]; #IO_L12P_T1_MRCC_14 Sch=ja_p[2]
set_property -dict { PACKAGE_PIN T27   IOSTANDARD LVCMOS33 } [get_ports { o_miso }]; #IO_L12N_T1_MRCC_14 Sch=ja_n[2]
